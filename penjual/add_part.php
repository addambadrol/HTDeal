...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        $stmt = $pdo->prepare("INSERT INTO inventory (part_code, category, part_name, stock, price) VALUES (?, ?, ?, ?, ?)");
        $stmt->execute([$part_code, $category, $part_name, $stock, $price]);
