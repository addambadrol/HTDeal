    ...
    <div class="delete-card">
      ...
      <div class="part-details">
        ...
        <div class="detail-row">
          ...
          <span class="detail-value"><?php echo htmlspecialchars($part['part_code']); ?></span>
        </div>
        <div class="detail-row">
          <span class="detail-label">Category:</span>
          <span class="detail-value"><?php echo htmlspecialchars($part['category']); ?></span>
        </div>
        <div class="detail-row">
          <span class="detail-label">Part Name:</span>
          <span class="detail-value"><?php echo htmlspecialchars($part['part_name']); ?></span>
        </div>
        <div class="detail-row">
          <span class="detail-label">Stock:</span>
          <span class="detail-value"><?php echo $part['stock']; ?></span>
        </div>
        <div class="detail-row">
          <span class="detail-label">Price:</span>
          <span class="detail-value">RM <?php echo number_format($part['price'], 2); ?></span>
        </div>
      </div>
