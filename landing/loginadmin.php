...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($email) || empty($password)) {
        ...
        try {
            ...
            $stmt = $pdo->prepare("SELECT * FROM account WHERE email = ? AND role = 'admin'");
            $stmt->execute([$email]);
...
<title>HTDeal - Log In Admin</title>
...
<main>
  ...
  <div class="login-container">
    ...
    <div class="extra-login">
      <p>Are you a customer? <a href="loginpelanggan.php">Log In now.</a></p>
      <p>Are you an seller? <a href="loginpenjual.php">Log In now.</a></p>
    </div>
  </div>
</main>
