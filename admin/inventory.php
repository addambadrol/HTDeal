...
<style>
  * {
  ...
  .options table th:nth-child(5) { width: 120px; }
  .options table th:nth-child(6) { width: 120px; }
  .options table th:nth-child(7) { width: 80px; }
...
<body>
  ...
  <div class="container">
    <div class="configurator">
      ...
      foreach($categories as $categoryKey => $categoryDisplay): 
        $parts = getPartsByCategory($pdo, $categoryDisplay);
        ...
        <div class="options">
          <table>
            ...
            <tbody>
              <?php if(empty($parts)): ?>
                <tr>
                  <td colspan="7" class="empty-message">No parts available in this category</td>
                </tr>
              <?php else: ?>
                ...
                <tr data-part-id="<?php echo $part['part_id']; ?>" 
                    ...
                    data-purchase-price="<?php echo number_format($part['purchase_price'], 2); ?>"
                    data-selling-price="<?php echo number_format($part['selling_price'], 2); ?>"
                  ...
                  <td><?php echo number_format($part['purchase_price'], 2); ?></td>
                  <td><?php echo number_format($part['selling_price'], 2); ?></td>
                  <td>
  ...
  <div id="partModal" class="modal">
    <div class="modal-content">
      ...
      <div class="modal-info">
        <span class="modal-info-label">Purchase Price:</span>
        <span class="modal-info-value" id="modalPurchasePrice"></span>
      </div>
      
      <div class="modal-info">
        <span class="modal-info-label">Selling Price:</span>
        <span class="modal-info-value" id="modalSellingPrice"></span>
      </div>
      ...
      <div class="modal-buttons">
        <button class="modal-btn delete" onclick="deletePart()">Delete</button>
        <button class="modal-btn edit" onclick="editPart()">Edit</button>
      </div>
    </div>
  </div>
  ...
  <script>
    ...
    function showModal(row) {
      ...
      const sellingPrice = row.getAttribute('data-selling-price');
      ...
      document.getElementById("modalPurchasePrice").textContent = "RM " + purchasePrice;
      document.getElementById("modalSellingPrice").textContent = "RM " + sellingPrice;
