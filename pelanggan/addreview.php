...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($rating) || empty($review_text)) {
        ...
        if (empty($error)) {
            try {
                $stmt = $pdo->prepare("INSERT INTO reviews (account_id, reviewer_type, rating, review_text, review_image, status) VALUES (?, 'pelanggan', ?, ?, ?, 'active')");
  ...
  <div class="container">
    ...
    <div class="form-card">
      <div class="form-header">
        ...
        <p>Tell us about your experience with our service</p>
      </div>
      ...
      <form method="POST" action="" enctype="multipart/form-data">
        <div class="form-group">
          ...
          <div class="form-hint">Click on the stars to rate your experience</div>
        </div>
        
        <div class="form-group">
          <label>Your Review <span>*</span></label>
          <textarea name="review_text" placeholder="Share your thoughts about our service..." required><?php echo isset($_POST['review_text']) ? htmlspecialchars($_POST['review_text']) : ''; ?></textarea>
          <div class="form-hint">Write a detailed review to help others</div>
        </div>
          ...
          <div class="image-upload-wrapper">
            ...
            <label for="review_image" class="image-upload-label" id="uploadLabel">
              <div class="upload-content">
                <div class="upload-icon"></div><br><br><br>
